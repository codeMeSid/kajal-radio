...
export const metadata: Metadata = {
  title: "Shamili2 Radio",
  description:
    "A girl lying on her bed in a Indian royal household set up with a bengali tradition theme with flowers or gajra in her hair, the late 1980s / 1990s",
};
...
export default function Shamili2Radio() {
  return (
    <main className="relative flex min-h-dvh flex-1 flex-col items-center justify-between overflow-hidden">
      {/* 1 — the scene */}
      <div className="hero-bg-shamili2 fixed inset-0 -z-20 bg-cover bg-center">
