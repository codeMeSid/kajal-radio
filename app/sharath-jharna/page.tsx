...
export const metadata: Metadata = {
  title: "Sharath Jharna Radio",
  description: "a secluded Hawaiian beach at sunset, present day",
};

const SAFE_TOP = "top-[max(1rem,env(safe-area-inset-top))]";
const SAFE_LEFT = "left-[max(1rem,env(safe-area-inset-left))]";

export default function SharathJharnaRadio() {
  return (
    <main className="relative flex min-h-dvh flex-1 flex-col items-center overflow-hidden">
      {/* 1 — the scene */}
      <div className="hero-bg-sharath-jharna fixed inset-0 -z-20 bg-cover bg-center">
