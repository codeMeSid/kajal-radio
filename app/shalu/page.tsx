...
export const metadata: Metadata = {
  title: "Shalu Radio",
  description:
    "Poo from Kabhi khushi kabhi Gham (Movie)'s room. Make Poo a lil curvy and chubby but hot with curly hair in a shimmery skirt and a halter neck top getting ready for a party with her girls while doing shots of vodka., Early 2000s",
};

const SAFE_TOP = "top-[max(1rem,env(safe-area-inset-top))]";
const SAFE_LEFT = "left-[max(1rem,env(safe-area-inset-left))]";

export default function ShaluRadio() {
  return (
    <main className="relative flex min-h-dvh flex-1 flex-col items-center overflow-hidden">
      {/* 1 — the scene */}
      <div className="hero-bg-shalu fixed inset-0 -z-20 bg-cover bg-center">
