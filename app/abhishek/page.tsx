...
export const metadata: Metadata = {
  title: "Abhishek Radio",
  description:
    "Big mansion backyard filled ultra luxury high performing cars arranged neatly in a row, with a guy standing in between with his arms open a smile on wearing white suit. with his wife next to him in Bangalore, 2020",
};

const SAFE_TOP = "top-[max(1rem,env(safe-area-inset-top))]";
const SAFE_LEFT = "left-[max(1rem,env(safe-area-inset-left))]";

export default function AbhishekRadio() {
  return (
    <main className="relative flex min-h-dvh flex-1 flex-col items-center overflow-hidden">
      {/* 1 — the scene */}
      <div className="hero-bg-abhishek fixed inset-0 -z-20 bg-cover bg-center">
