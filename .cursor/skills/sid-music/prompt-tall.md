...
The HTML page will overlay a compact horizontal music-player PILL (~80–90px tall, full width) across the BOTTOM of the phone. Inside that pill (do not paint it): disc on the left, a thin seeker along the top of the remaining space, prev/play/next centered below the seeker. Keep the important figures, the shop, the main story, and [STREET LIFE] in the UPPER and MIDDLE ~75% of the frame. The bottom ~12–15% must be quieter painted ground / pavement / shadow / empty street — readable even when that band is covered. Do NOT paint the player. Do NOT paint any UI, disc, buttons, or seeker. Do NOT leave a blank white bar. Just compose the scene so the story sits above that band.
